...
status: active
legacy_source: components/docs/plans/change-plan-workflow.md
converted_at: 2026-04-27
title: Change Plan Workflow
...
- Queue view supports auto-rollback outcome badges and outcome filters.
  ...
  Queue summary shows how many runs match the current filter.
  Queue rows also show verification backend badges (for example `verify: forward`).
